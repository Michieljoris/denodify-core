...
module.exports = {
    ...
    "homepage": "https://github.com/michieljoris/denodify-core",
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/denodify-core.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/denodify-core/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called denodify-core which is linked to
    //./bin/denodify-core in the local package.

    //If we have installed this package globally using npm install denodify-core
    //-g we will be able to call this new command denodify-core from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/denodify-core.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/denodify-core.js"
    }
};
